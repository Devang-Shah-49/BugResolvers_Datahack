      ...
      <a href="/" className="pl-7 logo lg:ml-10">
        <img height="65%" width="65%" src={logo} alt="logo" />
             ...
             openNav &&
              <div ref={wrapperRef} className="absolute top-0 w-full h-48 bg-white">
                ...
                <div className="flex flex-col items-center justify-around h-full pt-5">
                  ...
                  <a onClick={()=>setOpenNav(false)} href="/login" className="text-lg font-semibold text-blue-800 transition-all hover:text-orange-500">Login</a>
                </div>
              </div>
          }
          ...
          <div className="flex justify-around w-2/5 mr-12 lg:visible sm:invisible">
              ...
              <button className="pt-1 pb-2 pl-10 pr-10 text-xl font-semibold text-center text-white transition-all bg-orange-600 rounded-full shadow-2xl lg:ml-5 hover:bg-orange-700 focus:outline-none ring-4 ring-orange-600 lg:ring-2 lg:font-medium ">
